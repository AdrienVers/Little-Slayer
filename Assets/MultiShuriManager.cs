...
public class MultiShuriManager : MonoBehaviour
{
	...
	public void Shoot(GameObject bullet)
	{
		if (GetComponentInParent<PlayerMovement>().transform.localScale.x == 1)
		{
			...
			newBullet1.GetComponent<Rigidbody2D>().AddForce(transform.right * (GetComponentInChildren<DrawLine>().LaunchForce + 160));

			GameObject newBullet2 = Instantiate(bullet, ShootPointRight2.position, transform.rotation);
			newBullet2.GetComponent<Rigidbody2D>().AddForce(transform.right * (GetComponentInChildren<DrawLine>().LaunchForce + 80));

			GameObject newBullet3 = Instantiate(bullet, ShootPointRight3.position, transform.rotation);
			newBullet3.GetComponent<Rigidbody2D>().AddForce(transform.right * (GetComponentInChildren<DrawLine>().LaunchForce));

			GameObject newBullet4 = Instantiate(bullet, ShootPointRight3.position, transform.rotation);
			newBullet4.GetComponent<Rigidbody2D>().AddForce(transform.right * (GetComponentInChildren<DrawLine>().LaunchForce - 80));

			GameObject newBullet5 = Instantiate(bullet, ShootPointRight3.position, transform.rotation);
			newBullet5.GetComponent<Rigidbody2D>().AddForce(transform.right * (GetComponentInChildren<DrawLine>().LaunchForce - 160));
		}
		...
		if (GetComponentInParent<PlayerMovement>().transform.localScale.x == -1)
		{
			...
			GameObject newBullet4 = Instantiate(bullet, ShootPointLeft3.position, transform.rotation);
			newBullet4.GetComponent<Rigidbody2D>().AddForce(transform.right * (GetComponentInChildren<DrawLine>().LaunchForce - 80));

			GameObject newBullet5 = Instantiate(bullet, ShootPointLeft3.position, transform.rotation);
			newBullet5.GetComponent<Rigidbody2D>().AddForce(transform.right * (GetComponentInChildren<DrawLine>().LaunchForce - 160));
		}
	}
